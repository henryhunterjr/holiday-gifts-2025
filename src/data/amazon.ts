...
export const amazonProducts: AmazonProduct[] = [
  ...
  { name: "Challenger Bread Pan", category: "Bread Pan", img: "https://cdn.apartmenttherapy.info/image/upload/f_jpg,q_auto:eco,c_fill,g_auto,w_1500,ar_4:3/at%2Fnews-culture%2F2020-02%2FChallenger%2520Bread%2520Pan_Family_hi-res-2", price: "$295", rating: 4.9, url: link("B07M6MF86P"), note: "Shallow base, easy load, no reaching into a screaming hot pot. The upgrade you keep." },
  ...
  { name: "Wire Monkey UFO Lame", category: "Scoring", img: "https://wiremonkey.com/cdn/shop/products/MG_0020_1445x.jpg?v=1573946504", price: "$35", rating: 4.9, url: link("B07KPTC1FN"), note: "The lame that made me care about scoring. Set your angle and it holds it." },
  ...
  { name: "Brod & Taylor Dough Whisk", category: "Whisk", img: whisk, price: "$16.00", rating: 4.8, url: link("B0821K5RDJ"), note: "Stirs flour into starter without gluing itself shut. Sixteen dollars, used every day." },
